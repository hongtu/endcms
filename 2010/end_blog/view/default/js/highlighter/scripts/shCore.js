...
SyntaxHighlighter.brushes.AS3.aliases	= ['actionscript3', 'as3','as'];
...
SyntaxHighlighter.config.clipboardSwf = 'end_blog/view/default/js/highlighter/scripts/clipboard.swf';
...
with(SyntaxHighlighter.config.strings)
{
	...
	viewSource = '查看源代码';
	copyToClipboard='复制';
	copyToClipboardConfirmation = '源代码已经复制到您的剪贴板';
	alert = "";
}
