...
INSERT INTO `end_category` (`category_id`, `parent_id`, `name`, `description`, `keywords`, `order_id`, `status`, `update_time`, `create_time`, `url`, `content`, `target`, `page_title`) VALUES
(10, 9, 'Index', '返回首页', NULL, 0, 'link', 1269226601, 0, './', '', '_self', ''),
(11, 9, 'About', '刘春龙的个人简介', '刘春龙', 0, 'page', 1269226253, 0, '', '<p>\r\n	哈哈哈。不错啊</p>\r\n', '', '关于刘春龙'),
(12, 9, 'Projects', 'ceshi', 'ceshi', 0, 'page', 1269226254, 0, '', '<p>\r\n	fdsaf sadfdsa </p>\r\n', '', '测试'),
(9, 5, '导航', NULL, NULL, -2, 'folder', 1269617123, 0, '', '', '', ''),
(5, 0, '博客', NULL, NULL, 0, 'folder', 1269226071, 0, '', '', '', ''),
(6, 5, 'Works', NULL, NULL, 0, 'blog_list', 1269226114, 0, '', '', '', ''),
(7, 5, 'Mac', NULL, NULL, 0, 'blog_list', 1269226116, 0, '', '', '', ''),
(8, 5, 'Other', NULL, NULL, 0, 'blog_list', 1269226119, 0, '', '', '', '');
