...
(6, 0, 'Configuraton', NULL, NULL, -1, 'config_list', 1282226960, 1282027016, 'config', '', '', '', '', 'no', 0, ''),
...
(15, 0, 'Orders', NULL, NULL, 0, 'order_list', 1282226929, 1282226923, 'Orders', '', '', '', '', 'no', 0, ''),
(16, 0, 'Slideshow', NULL, NULL, 0, 'slideshow_list', 1282226938, 1282226933, 'Slideshow', '', '', '', '', 'no', 0, ''),
(17, 0, 'Coupons', NULL, NULL, 0, 'coupon_list', 1282229256, 1282229250, 'Coupons', '', '', '', '', 'no', 0, '');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='admin settings' AUTO_INCREMENT=16 ;
...
(15, 6, 'brands', 'LG,Motorola,Samsung,HTC,Apple,Palm,LG,&nbsp;Motorola,&nbsp;<br>Samsung,HTC,Apple,Palm,LG,&nbsp;Motorola,&nbsp;Samsung', '2010-08-19 22:42:08', '', 'Brands (seperated with comma )', 0);
...
(1, 'NOSHIPPING', 'free shippment', 1282207814, 1313743814, 999, '{shipping}', 0, 200),
...
INSERT INTO `end_order` (`order_id`, `user_id`, `name`, `email`, `shipping`, `billing`, `create_time`, `status`, `product_ids`, `total`, `shipping_price`, `ship_method`, `coupon`, `coupon_price`) VALUES
